...
const messages: Record<Locale, DictObject> = {
  "zh-CN": {
    ...
    helpAssistant: {
      ...
      button: "AI 帮助",
      title: "AI 帮助助手",
      subtitle: "输入问题，获取流程建议与下一步操作。",
      inputPlaceholder: "例如：为什么我支付失败了？",
      ask: "提问",
      asking: "思考中...",
      quickTitle: "快捷问题",
      q1: "首笔支付怎么做？",
  ...
  "en-US": {
    ...
    helpAssistant: {
      ...
      subtitle: "Ask questions and get guided next actions.",
      inputPlaceholder: "e.g. Why did my payment fail?",
      ask: "Ask",
      asking: "Thinking...",
      quickTitle: "Quick Questions",
      q1: "How do I run my first payment?",
      q2: "Why does payment fail?",
      q3: "What if recharge address is empty?",
      answer: "Suggestion",
      nextActions: "Next Actions",
      noAction: "No direct action available, check docs first.",
    },
    login: {
      title: "AI Pay Login",
