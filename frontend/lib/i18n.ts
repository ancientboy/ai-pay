...
const messages: Record<Locale, DictObject> = {
  "zh-CN": {
    ...
    selfHosted: {
      title: "Self-hosted Signing",
      subtitle: "Wallet binding, auth sessions, and two-step signed payment",
      walletTitle: "Wallet Binding",
      walletAddress: "Wallet Address",
      walletLabel: "Wallet Label (optional)",
      bindWallet: "Bind Wallet",
      unbindWallet: "Unbind Wallet",
      walletBound: "Wallet bound",
      walletUnbound: "Wallet unbound",
      sessionTitle: "Authorization Session",
      ...
      signTitle: "Two-step Signed Payment",
      merchantId: "Merchant ID",
      amount: "Amount",
      requestSign: "Create Sign Request",
      signRequested: "Sign request created",
      pendingSign: "Pending Sign Request",
      signId: "Sign ID",
      submitSigned: "Submit Signed Payment",
      signSubmitted: "Signed payment submitted",
      transactionId: "Transaction ID",
      status: "Status",
      noSession: "No active session",
      noSignRequest: "No sign request yet",
      requiredError: "Please fill required fields first",
    },
    developer: {
      title: "开发者中心",
  ...
  "en-US": {
    ...
    landing: {
      badge: "AI Native Payments",
      title: "Payment infrastructure for AI agents",
      subtitle: "Unified onboarding, signed payments, risk controls, and fund operations.",
      ctaLogin: "Sign in",
      ctaConsole: "Open Console",
      ctaStart: "Get Started",
      pricingTitle: "Pricing Plans",
      pricingSubtitle: "Pick a plan for your stage",
      planFree: "Free",
      planPro: "Pro",
      planEnterprise: "Enterprise",
      planFreeDesc: "Individuals and PoCs",
      planProDesc: "Team production pilots",
      planEnterpriseDesc: "Scale and compliance-heavy cases",
      featAgents: "Agents",
      featApiCalls: "Monthly API calls",
      featSelfHosted: "Self-hosted signing",
      featSupport: "Support",
      valueFreeAgents: "3",
      valueProAgents: "50",
      valueEntAgents: "Unlimited",
      valueFreeCalls: "50,000",
      valueProCalls: "5,000,000",
      valueEntCalls: "Custom",
      valueFreeSelfHosted: "No",
      valueProSelfHosted: "Yes",
      valueEntSelfHosted: "Yes + dedicated policy",
      valueFreeSupport: "Community",
      valueProSupport: "Business hours",
      valueEntSupport: "24/7 expert",
      loginEntryTitle: "Login Entry",
      loginEntryDesc: "Use your existing account to sign in and route by role.",
      roleEntryTitle: "Role-based Entry",
      roleEntryUser: "User/Operator: business console (agents, payments, funds, risk)",
      roleEntryAdmin: "Admin: management entry (developer center, policy, audit)",
    },
    dashboard: {
      title: "Dashboard",
