...
const messages: Record<Locale, DictObject> = {
  "zh-CN": {
    ...
    landing: {
      ...
      featureBillingDesc:
        "组织级 Stripe 结账、支付链接充值、对账与导出；Bridge 能力用于 KYC 与 VA（按环境配置）。",
  ...
  "en-US": {
    ...
    landing: {
      ...
      featureBillingDesc:
        "Org-level Stripe checkout, payment-link top-up, reconciliation and export; Bridge for KYC/VA when configured.",
