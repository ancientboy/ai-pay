...
const messages: Record<Locale, DictObject> = {
  "zh-CN": {
    ...
    risk: {
      title: "风控工作台",
      subtitle: "执行交易风控校验、当事人 KYC 与审计查询",
      txCheckTitle: "交易风控校验",
      txCheckSubmit: "执行风控校验",
      kycTitle: "当事人 KYC 验证",
      kycSubmit: "执行 KYC 验证",
      auditTitle: "风控审计查询",
      auditDetail: "审计详情",
      auditAgentDid: "筛选 Agent DID",
      auditMerchantId: "筛选商户 ID",
      agentDid: "Agent DID",
      merchantId: "商户 ID",
      amount: "金额",
      transactionId: "交易 ID（可选）",
      documentReference: "材料引用（可选）",
      requiredError: "请先填写必填字段",
      runTxCheck: "执行风控校验",
      runKycVerify: "执行 KYC 验证",
      queryAudit: "查询审计",
      decision: "决策",
      code: "错误码",
      message: "消息",
  ...
  "en-US": {
    ...
    risk: {
      ...
      subtitle: "Run transaction checks, party KYC, and audit search",
      txCheckTitle: "Transaction Risk Check",
      txCheckSubmit: "Run Risk Check",
      kycTitle: "Party KYC Verification",
      kycSubmit: "Run KYC Verify",
      auditTitle: "Risk Audit Query",
      auditDetail: "Audit Detail",
      auditAgentDid: "Filter Agent DID",
      auditMerchantId: "Filter Merchant ID",
      agentDid: "Agent DID",
      merchantId: "Merchant ID",
      amount: "Amount",
      ...
      runTxCheck: "Run Risk Check",
      runKycVerify: "Run KYC Verify",
      ...
      txCheckSuccess: "Risk check completed",
      kycSuccess: "KYC verification completed",
    },
    status: {
      active: "Active",
      settled: "Settled",
