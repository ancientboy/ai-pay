...
const messages: Record<Locale, DictObject> = {
  ...
  "en-US": {
    ...
    billing: {
      title: "Billing",
      subtitle: "Show fiat and stablecoin collection entries by provider capability",
      ...
      checkoutTitle: "Create collection checkout (placeholder)",
