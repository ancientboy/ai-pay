...
const messages: Record<Locale, DictObject> = {
  "zh-CN": {
    ...
    cards: {
      title: "卡中心",
      subtitle: "开设、管理并使用 Agent 虚拟卡",
      applyTitle: "开卡",
      agentDid: "Agent DID",
      vaAccountId: "VA 账户 ID",
      creditLimit: "卡额度",
      apply: "申请开卡",
      payTitle: "卡支付",
      cardId: "卡 ID",
  ...
  "en-US": {
    ...
    cards: {
      title: "Cards",
      subtitle: "Issue, manage, and use agent virtual cards",
      applyTitle: "Issue Card",
      agentDid: "Agent DID",
      vaAccountId: "VA Account ID",
      ...
      operation: "Operation",
      adjustAmount: "Adjusted Limit",
      manage: "Apply Operation",
      latestCards: "Recent Cards",
      latestPayments: "Recent Card Payments",
      noCards: "No card records",
      noPayments: "No card payments yet",
      applySuccess: "Card issued",
      paySuccess: "Card payment succeeded",
      manageSuccess: "Card operation succeeded",
    },
    transactions: {
      title: "Transactions",
